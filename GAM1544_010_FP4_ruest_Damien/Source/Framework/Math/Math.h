...
namespace GameDev2D
{
    struct Math
    {
        ...
        static Vector2 CalculateOrbit(const Vector2& pivot, Rotation angle, float distance);

        static Vector2 CalculateTrajectoryPoint(const Vector2& startingPosition, const Vector2& startingVelocity, const Vector2& gravity, float targetFPS, float step);
       
        static Vector2 CalculateClosestPoint(const Vector2& circleCenter, float radius, const Vector2& lineStart, const Vector2& lineEnd);
